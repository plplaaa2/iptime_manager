...
- 선택한 기기마다 재실 센서를 만들고 `Home Presence` 기기 아래에 모아 표시
...
4. 공유기는 주소와 관리자 계정을 입력합니다. 재실 센서는 등록된 공유기에서 기기를 선택한 뒤 기기마다 센서 이름을 설정합니다.

재실 센서는 단일 공유기 또는 EasyMesh 컨트롤러가 등록돼 있을 때 만들 수 있습니다. 선택한 기기는 Agent를 포함해 등록된 모든 공유기에서 감지하며, 기기별 센서는 해당 기기가 감지될 때 켜집니다. 센서들은 `Home Presence` 기기 아래에 표시됩니다.
