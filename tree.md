...
- device_tracker.py: exposes per-client Home Presence device trackers and removes obsolete tracker or binary sensor entities.
- presence.py: aggregates selected device presence across all configured router coordinators for per-client Home Presence trackers.
